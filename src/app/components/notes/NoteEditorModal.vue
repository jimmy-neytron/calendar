...
<style scoped>
.note-editor{display:grid;gap:12px}.note-editor__meta{display:grid;grid-template-columns:1fr 1fr;gap:9px}.note-editor__content :deep(textarea){min-height:300px;line-height:1.6}.note-editor__pin{display:flex;align-items:center;gap:9px;width:fit-content;color:var(--text-secondary);font-size:11px;font-weight:700}.note-editor__error{margin:0;color:var(--danger);font-size:11px}.note-editor footer{display:flex;justify-content:flex-end;gap:8px;border-top:1px solid var(--border-color);padding-top:12px}@media(max-width:620px){.note-editor__meta{grid-template-columns:1fr}.note-editor__content :deep(textarea){min-height:220px}}
</style>
