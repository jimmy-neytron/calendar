<template>
  <section class="time-composer panel">
    ...
    <form v-if="showProjectForm" class="project-form" @submit.prevent="createProject">
      ...
      />
      <div class="project-colors" aria-label="Цвет проекта">
        <button
          v-for="color in projectColors"
          :key="color"
          type="button"
          :class="{ active: projectColor === color }"
...
const projectColor = ref(projectColors[0])
