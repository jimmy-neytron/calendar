export const UI_ICONS = Object.freeze({
  ...
  left: { paths: ['M15 18l-6-6 6-6'] },
  right: { paths: ['M9 18l6-6-6-6'] },
  ...
  search: { paths: ['M11 18a7 7 0 100-14 7 7 0 000 14z', 'M20 20l-4-4'] },
  heart: { paths: ['M20.8 4.6a5.5 5.5 0 00-7.8 0L12 5.7l-1.1-1.1a5.5 5.5 0 00-7.8 7.8L12 21l8.8-8.6a5.5 5.5 0 000-7.8z'] },
  sparkles: { paths: ['M12 3l1.3 4.2L17 9l-3.7 1.8L12 15l-1.3-4.2L7 9l3.7-1.8L12 3z', 'M19 15l.7 2.3L22 18l-2.3.7L19 21l-.7-2.3L16 18l2.3-.7L19 15z'] },
  sport: { paths: ['M6 8v8', 'M3 10v4', 'M18 8v8', 'M21 10v4', 'M6 12h12'] },
  ...
  user: { paths: ['M20 21a8 8 0 00-16 0', 'M12 13a5 5 0 100-10 5 5 0 000 10z'] },
  ...
  mail: { paths: ['M4 6h16v12H4z', 'M4 7l8 6 8-6'] },
  'message-square': { paths: ['M21 15a4 4 0 01-4 4H8l-5 3V7a4 4 0 014-4h10a4 4 0 014 4v8z'] },
  music: { paths: ['M9 18V5l11-2v13', 'M9 9l11-2', 'M6 21a3 3 0 100-6 3 3 0 000 6z', 'M17 19a3 3 0 100-6 3 3 0 000 6z'] },
  volume: { paths: ['M4 10v4h4l5 4V6l-5 4H4z', 'M16 9.5a4 4 0 010 5', 'M18.5 7a8 8 0 010 10'] },
...
export const UI_BUTTON_ICON_ALIASES = Object.freeze({
  '+': 'plus',
  '＋': 'plus',
  '→': 'right',
  '↓': 'download',
...
export function resolveUiIcon(name) {
  return UI_ICONS[name] || UI_ICONS.warning
}

export function resolveUiButtonIcon(name) {
  const normalizedName = UI_BUTTON_ICON_ALIASES[name] || name
  return UI_ICONS[normalizedName] ? normalizedName : ''
}
