...
/* Улучшенное оформление раздела бюджета */
.budget-page {
  position: relative;
  padding-bottom: 12px;
}
...
/* Компактная панель: месяц, доход и итог должны быть видны одновременно. */
.budget-page::before,
.budget-stat::after {
  display: none;
}
