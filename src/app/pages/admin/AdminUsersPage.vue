...
<style scoped>
.admin-users-page{display:grid;gap:12px}.admin-section-hero{display:flex;align-items:center;justify-content:space-between;gap:18px}.admin-section-hero span{color:var(--accent);font-size:9px;font-weight:850;letter-spacing:.14em;text-transform:uppercase}.admin-section-hero h1{margin:5px 0 7px}.admin-section-hero p{margin:0;color:var(--text-secondary)}.admin-stats{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px}.admin-stats article{display:grid;grid-template-columns:40px minmax(0,1fr);align-items:center;gap:10px;min-height:72px;border:1px solid var(--border-color);border-radius:8px;padding:9px 12px;background:var(--card-solid);box-shadow:var(--shadow-sm)}.admin-stat-icon{display:grid;place-items:center;width:40px;height:40px;border-radius:8px;color:var(--accent);background:color-mix(in srgb,var(--accent) 10%,var(--control-bg));font-size:18px}.admin-stat-icon--success{color:var(--success);background:color-mix(in srgb,var(--success) 10%,var(--control-bg))}.admin-stat-icon--warning{color:var(--warning);background:color-mix(in srgb,var(--warning) 11%,var(--control-bg))}.admin-stats small{color:var(--text-muted);font-size:9px;font-weight:850;letter-spacing:.12em;text-transform:uppercase}.admin-stats strong{display:block;margin:3px 0 2px;font-size:22px;line-height:1}.admin-stats span:not(.admin-stat-icon){color:var(--text-secondary);font-size:11px}.admin-toolbar{display:grid;grid-template-columns:minmax(220px,1fr) 180px 180px;align-items:center;gap:8px;max-height:58px;padding:8px;overflow:visible}.admin-panel{overflow:hidden;border:1px solid var(--border-color);border-radius:8px;background:var(--card-solid);box-shadow:var(--shadow-sm)}.admin-state{display:grid;justify-items:center;gap:8px;padding:48px 16px;color:var(--text-secondary);text-align:center}.admin-state span{display:grid;place-items:center;width:44px;height:44px;border-radius:14px;color:var(--accent);background:color-mix(in srgb,var(--accent) 10%,var(--control-bg));font-size:20px}.admin-state--danger span{color:var(--danger);background:color-mix(in srgb,var(--danger) 10%,var(--control-bg))}.admin-table{display:grid;overflow-x:auto}.admin-table__row{display:grid;grid-template-columns:minmax(250px,1.5fr) 120px 150px 150px 150px;align-items:center;gap:12px;min-width:830px;border-top:1px solid var(--border-color);padding:11px 14px}.admin-table__row:first-child{border-top:0}.admin-table__row--head{min-height:42px;color:var(--text-muted);background:var(--control-bg);font-size:10px;letter-spacing:.08em;text-transform:uppercase}.admin-user{display:grid;grid-template-columns:38px minmax(0,1fr);align-items:center;gap:10px;min-width:0}.admin-user__avatar{display:grid;place-items:center;width:38px;height:38px;border-radius:50%;color:#071016;background:var(--user-color,var(--accent));font-weight:850}.admin-user strong,.admin-user small{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.admin-user small{margin-top:2px;color:var(--text-muted);font-size:10px}.admin-badge{display:inline-flex;justify-content:center;border:1px solid var(--border-color);border-radius:var(--radius-pill);padding:5px 8px;font-size:10px;font-weight:850}.admin-badge--success{color:var(--success);border-color:color-mix(in srgb,var(--success) 28%,var(--border-color));background:color-mix(in srgb,var(--success) 8%,var(--control-bg))}.admin-badge--danger{color:var(--danger);border-color:color-mix(in srgb,var(--danger) 28%,var(--border-color));background:color-mix(in srgb,var(--danger) 8%,var(--control-bg))}.admin-actions{display:flex;justify-content:flex-end}@media(max-width:760px){.admin-section-hero{display:grid}.admin-stats,.admin-toolbar{grid-template-columns:1fr}.admin-toolbar{max-height:none}.admin-panel{overflow-x:auto}}
</style>
