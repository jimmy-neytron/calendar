# Workspace Calendar — v1.9.0

Семейный workspace-календарь на Vue 3 с авторизацией, хранением и синхронизацией данных через Supabase. Приложение объединяет календарь, бюджет, спорт, учёт времени, идеи, дни рождения, список фильмов, уведомления, аналитику и совместную работу в пространствах.
